...
export const forgotPassword = TryCatch(async(req,res)=>{
  ...
  res.json({
    message: "Reset Password Link is send your mail",
  });
});
...
export const addQuizProgress = TryCatch(async (req, res) => {
  const { course, quizId } = req.query;
...
export const getQuizProgress = TryCatch(async (req, res) => {
  ...
  const quizCompleted = progress ? progress.completedQuizzes.length > 0 : false;
